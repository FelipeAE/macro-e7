...
run_timeout = int(int(input("How long should this macro be run for? (Enter in skytones): "))/3)
...
while ((exit_flag == 0) and (refresh_count < run_timeout)):
...
#Scroll down
    ...
    scroll_pt_y = random.randint(600,680)

    drag(scroll_pt_x, scroll_pt_y)
    #pyautogui.scroll(-random.randint(3,7), x=scroll_pt_x, y=scroll_pt_y) #default (3,7)
